...
- 宣伝型（PASONA法則）: 4本（うち2本=肩こりURL、2本=頭痛URL）
- 情報提供型（PRBREP・等価交換）: 21本
- 日常/共感型（ストーリー・問いかけ）: 5本
- 肩こり予約URL: {prof['cta_katakori']}
- 頭痛予約URL: {prof['cta_zutsuu']}
- CTAは「▶ 予約はこちら\\n[URL]」の形式で本文末に追加
"""
    else:
        cta_rule = f"""
【CTA配置ルール（小川教材7:2:1比率）】
- 宣伝型（PASONA法則+LINE誘導）: 3本（URLあり）
- 情報提供型（PRBREP・等価交換）: 21本
- 日常/共感型（ストーリー・問いかけ）: 6本
- さりげないLINE誘導（URLなし）: 4本
- LINE URL: {prof['line_url']}
"""
