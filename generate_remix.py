...
MASA_PATTERNS = {
    ...
    "gyakusetsu": [
        ("フォロワーを増やすより先にやることがある。",
         "理由：フォロワーが増えても\n導線がなければ問い合わせは来ません。\n\n{point}\n\n解決策：まずプロフィールに\n「何をしている人か」「次にどうすればいいか」を\n明記してください。順番が大事です。"),
        ("{topic}を頑張っているのに結果が出ない。",
         "理由はシンプルで\n{point}が抜けているから。\n\nツールの問題じゃなく、設計の問題です。\n\n解決策：今の{topic}を\n「誰に届けたいか」から逆算して\n組み直してみてください。"),
        ("コンサルに高いお金を払う前に、\nまず自分でやってみてください。",
         "理由：{point}\nこれは自分でできることです。\n\n知識より実践の数が成果を決めます。\n\n解決策：まず1週間\n毎日1投稿を{point}を意識してやってみて。\nそれだけで見えてくるものがあります。"),
        ("SNSより先に整えるべきものがあります。",
         "それは{point}です。\n\n理由：ここがないまま発信しても\n誰にも刺さらない投稿になるから。\n\n解決策：投稿を作る前に\n「この投稿で誰の何を変えたいか」を\n一文で書いてみてください。"),
    ],
    "insight": [
        ...
        ("導線設計の本質は、",
         "結果が出ない人は発信の目的が曖昧。\nこれだけです。\n\n投稿→プロフィール→問い合わせ\nこの流れが設計されているか。\n\n解決策：今のプロフィールを開いて\n「次に何をすればいいか」が\n3秒で分かるか確認してください。"),
        ("集客は「量」じゃなく「設計」で決まる。",
         "毎日投稿しても導線がなければ\n問い合わせにはつながりません。\n\n理由は、見た人が次に何をすればいいか分からないから。\n\n解決策：投稿の最後に\n「次のアクション」を1つだけ入れてみてください。\nそれだけで反応が変わります。"),
    ],
    "education": [
        ...
        ("{topic}を始める前に確認してほしいこと。",
         "{point}\n\nこれがないまま始めると\nどれだけ投稿しても遠回りになります。\n\n解決策：まず5分だけ時間を取って\n「誰に届けたいか」を紙に書き出してください。\nそこからすべてが始まります。"),
    ],
    "story": [
        "先日、お客様から\n「{topic}を見直したら問い合わせが増えた」\nと連絡をもらいました。\n\n{point}\n\n小さな改善が、大きな結果につながります。",
        "正直に言います。\n\n{topic}は魔法じゃない。\n{point}\n\n地道にやり続けた人だけが、結果を手にします。",
        ("集客に悩んでいる方へ。",
         "{topic}は手段であって目的じゃない。\n\n{point}\n\nまずゴールを決めて\nそこから逆算して設計すること。\n\n解決策：「3ヶ月後にどうなりたいか」を\n一文で書いてみてください。\nそこから逆算すれば、やることが明確になります。"),
    ],
    "cta": [
