...
MASA_PATTERNS = {
    ...
    "cta_profile": [
        "売上50万で止まる原因は、集客・成約・リピートのどれか1つ。\nどこが穴かを無料で特定する「集客の健康診断」をやっています。\n受け取り方はプロフィールのリンクからどうぞ。",
        "広告費をかける前に、やることがあります。\nいまの導線のどこで客が消えているかの診断です。\n無料の集客健康診断、プロフィールのリンクから受け取れます。",
        "「何から直せばいいか分からない」が一番もったいない状態。\nあなたの店のボトルネックを1つに絞る無料診断があります。\nプロフィールのリンクからどうぞ。",
        "集客の課題、自己流で当たりをつけると大体外れます。\n数字で見れば穴は1つに絞れる。\n無料の集客健康診断はプロフィールのリンクから。",
        "月商100万の壁は、頑張る量では越えられません。\n集客×成約×LTVのどこを直すかで決まります。\nまず現状診断から。プロフィールのリンクへ。",
        "フォロワーが少なくても新規は取れます。\n大事なのは数より導線。\nあなたの導線のどこが切れてるか、無料診断で分かります。プロフィールのリンクから。",
        "リピートが増えない店は、テクニック不足ではなく設計不足。\nどの段階で客が離れているか、無料の健康診断で数字にできます。\nプロフィールのリンクからどうぞ。",
        "「投稿は続けてるのに問い合わせゼロ」なら、直すのは投稿ではありません。\n導線です。\nどこが切れてるかの無料診断、プロフィールのリンクから。",
        "集客がうまい店は、才能ではなく「どこを直すか」を知っているだけ。\nあなたの店の直すべき1箇所、無料診断で特定します。\nプロフィールのリンクへ。",
        "値下げしないと予約が入らないなら、伝え方の問題です。\n強みが3秒で伝わっているかを含め、無料の集客健康診断でチェックできます。\nプロフィールのリンクから。",
        "新規換算で広告費いくら使ってますか？\nその半分、導線の修正で浮くことが多いです。\nまず現状の無料診断から。プロフィールのリンクへどうぞ。",
        "SNS・マップ・ホットペッパー、全部中途半端になっていませんか。\n伸びる店は1つに集中しています。どれに絞るべきかは診断で分かります。\nプロフィールのリンクから無料でどうぞ。",
    ],
