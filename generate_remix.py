...
MASA_PATTERNS = {
    ...
    "cta_profile": [
        # LINE登録の約束は実際の特典と一致させる: ①整体院の集客力・自己診断チェックシート(登録直後)
        # ②7日間で「次に手をつけるべき1つ」が分かるミニ講座。面談・金額は投稿では出さない(LINE内Day6-7のみ)
        "月50万で止まる原因、実は3問で当たりがつきます。\n新規数・リピート率・停滞期間。\nこの3問の自己診断チェックシートを、プロフィールのリンク先で配っています。",
        "自分の院のボトルネック、数字で言えますか？\n言えないなら、まず3問の診断から。\n整体院の集客力チェックシート、プロフィールのリンクから受け取れます。",
        "僕が面談で最初に聞く3つの質問を、チェックシートにしました。\n月の新規数・2回目来院率・停滞月数。\n答えるだけで「次に手をつける1つ」が絞れます。プロフィールのリンクからどうぞ。",
        "集客の勉強より先に、現在地の診断です。\n地図がないまま歩いても遠回りになるだけ。\n3分で終わる整体院の集客力チェック、プロフィールのリンクに置いてあります。",
        "「全部が課題に見える」は、何も直せないのと同じ。\n直す順番はリピート→単価→新規です。\nあなたの院がどこからかは、プロフィールのリンク先の自己診断で分かります。",
        "広告費を増やす前に、3問だけ答えてみてください。\n新規数・リピート率・停滞期間。\nどこにお金が漏れているかが見えます。診断シートはプロフィールのリンクから。",
        "感覚経営から数字経営に変わる最初の一歩は、たった3問。\n僕の面談でも必ず最初に聞く質問です。\nチェックシートにまとめたので、プロフィールのリンクからどうぞ。",
        "月商の停滞が6ヶ月以上続いているなら、原因は「頑張り不足」ではありません。\n手を打つ場所のズレです。\nズレを特定する自己診断、プロフィールのリンクに置いています。",
        "リピート率40%未満の院が新規集客を頑張ると、バケツの穴が広がります。\n自分の院の穴がどこかは3問で分かる。\n診断チェックシートはプロフィールのリンクから。",
        "成約率97%と47%の差の話、続きは登録者だけに送っています。\n7日間で「次に手をつける1つ」まで絞れるミニ講座です。\n入口はプロフィールのリンクから。",
        "72件のカウンセリング録音を分析した結果も、7日間の無料講座で公開しています。\n初日に3問の集客力診断シートが届きます。\nプロフィールのリンクからどうぞ。",
        "「何を発信すればいいか分からない」院長へ。\nその答えの前に、まず現在地の診断です。\n3問のチェックシート＋7日間のミニ講座、プロフィールのリンクから受け取れます。",
        # ── 2026-07-15追加: masa Threads改善設計（多様性拡張・7日重複ガード対策）──
        "予約が増えない理由、実はたった3つの質問で見えてきます。\n新規数・リピート率・来院間隔。\nプロフィールのリンク先に、その場で答えられる自己診断シートを置いています。",
        "「何から手をつければいいか分からない」を3分で終わらせる方法があります。\n3つの質問に答えるだけの集客力チェックシート、プロフィールのリンクからどうぞ。",
        "院の課題は、感覚ではなく数字で見ると早く見つかります。\n新規数・リピート率・停滞期間の3問で今の位置が分かる診断シート、プロフィールのリンクに置いています。",
        "忙しくて勉強する時間がない方へ。\n3つの質問に答えるだけで「今どこが弱いか」が分かる自己診断シートを、プロフィールのリンクから受け取れます。",
        "「このままでいいのか」が漠然としているなら、まず数字で確認してみませんか。\n3問の集客力チェックシート、プロフィールのリンクからどうぞ。",
        "登録すると、集客の現在地が分かる3問の診断シートがまず届きます。\nそのあと7日間、毎日1つずつ次にやることが分かる話を届けています。\nプロフィールのリンクから。",
        "何を直せば予約が増えるか、自分では意外と気づきにくいものです。\n3つの質問で見える化する診断シートを、プロフィールのリンクで配っています。",
        "「頑張っているのに変わらない」院ほど、直す場所がズレていることがあります。\n3問で現在地を確認できる診断シート、プロフィールのリンクからどうぞ。",
        "集客の話を聞く前に、まず自分の院の数字を知ってほしいです。\n3つの質問に答えるだけの診断シートをプロフィールのリンクに置いています。",
        "新規は来るのにリピートしない、広告費をかけてるのに増えない。\nそんな悩みの原因が3問で絞り込めます。診断シートはプロフィールのリンクから。",
    ],
...
def generate_30_masa_posts() -> list[str]:
    ...
    for _ in range(2):
        for _ in range(20):
            ...
            if p and "プロフィール" in p and p not in prof_cta:
                prof_cta.append(p)
                break
