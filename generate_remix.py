...
AI_JITSUREI_TEMPLATES = [
    "Threads3アカウント、1日150本の投稿を僕は1本も書いていません。\n全部AIが書いて、AIが投稿して、AIが翌朝に反省会をしています。\n僕がやるのは、その反省会の結果を読むだけ。",
    "AIで自動投稿しているアカウントが、月73万閲覧になりました。\n秘密は文章のうまさじゃなく、毎朝『昨日の負けパターンを捨てる』仕組みです。\n人間は飽きて続きませんが、AIは毎日やります。",
    "【僕の店でAIに任せていること】\n・Threadsの投稿（1日150本）\n・Instagramのストーリー（1日4回）\n・LINE登録後の7日間の配信\n・YouTube動画の作成と公開\n・投稿が止まった時の復旧と通知\n僕がやるのは、お客さんと向き合うことだけ。",
    "自動化で一番大事なのは『止まった時に気づけるか』です。\n僕の仕組みは、投稿が止まると30分以内にAIが検知して直し、直らなければスマホに通知が来ます。\n止まらない仕組みより、止まっても戻る仕組み。",
    "AIに投稿を書かせると質が落ちる、と思っていませんか。\n落ちるのは『書かせっぱなし』の時だけ。\n毎朝、閲覧数で採点して負けた型を捨てさせると、人が書くより安定します。",
    "整体院のLINEに登録された方へ、7日間のメッセージが自動で届きます。\n1通目は3問の診断、7日目に個別の相談案内。\n僕が手で送る必要は、もうありません。",
    "YouTube動画、毎朝8時にAIが作って18時に自動で公開されています。\n台本から公開まで。\n僕が朝やるのは、できた動画を一本確認するだけです。",
    "店舗経営の本を、AIが週に2冊書いています。\nすでに4冊がKindleで出版されました。\n「本を書く時間がない」は、理由にならなくなりました。",
    "AIに任せると手抜きに見えないか。\n逆です。\n1日150本投稿して毎朝改善する量を、人力でやったら誰も続きません。",
    "自動化して浮いた時間で僕がやっていること。\n・お客さんの話を聞く\n・数字を見る\n・仕組みを1つ直す\nこの3つだけで、店は回ります。",
    "AIの自動化を見た同業の先生に一番聞かれること。\n『難しくないですか？』\n難しいのは最初の設計だけで、回り始めたら僕はほぼ触っていません。",
    "集客の自動化、どこから始めればいいか。\n投稿でも広告でもなく『登録後の7日間』からです。\nここをAIに任せると、新規を追う前に手元のお客さんが戻ってきます。",
    "僕のThreadsは、毎朝7時にAIが前日の全投稿を採点しています。\n伸びた型は残し、沈んだ型は捨てる。\nこれを人がやると3日で飽きる。AIは3ヶ月続けています。",
    "投稿を自動化した店と、していない店の差は『文章』じゃありません。\n『毎日出し続けられるか』です。\n1日50本を半年続けられる人間はいないので、そこをAIに任せました。",
    "AIで仕組み化したら、僕の店のSNSは『誰も書いていないのに毎日50本出る』状態になりました。\n不思議がられますが、やっていることは単純です。\n昨日の結果を見て、今日の投稿を少し変える。それだけ。",
]
